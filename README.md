...
Try to import these tables (.csv) files into R and get an overview of tissue-distribution, and the role of the gene group of your interest in the datasets. (Follow here the basic steps, denoted in the R course from Carl Hermann, lecture 1, 2, 3 and the R Course from Maria Dinkelacker, lecture 1, 2).
